...
import com.diracsens.fallprevention.utils.SquareCardItemDecoration
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupFeatureGrid() {
        ...
        recyclerView.addItemDecoration(SquareCardItemDecoration(2, spacingInPixels))
        recyclerView.adapter = FeatureCardAdapter(features) { feature ->
